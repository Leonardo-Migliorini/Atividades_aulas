...
# fit_all <- glm(GHGC ~ UNNC + UCAC + GCCP + OR + DGCC + DOCC + Africa + Europe + America + Asia, family = Gamma(link = "log"), data=dados) # ajustando o modelo
# summary(fit_all)
# step(fit_all)
...
ggplot(data = dados, aes(x = GHGC, y = fitted(fit))) +
