...
dados<-readxl::read_excel("C:\\Users\\leona\\Dropbox\\Faculdade\\6° Semestre\\Séries Temporais I\\Dados\\ipeadata[03-04-2024-01-55].xls")
...
# analise descritiva 
summary(d1)
plot(decompose(d1, type = "additive"))
plot(decompose(d1, type = "multiplicative"))
...
#-------------------------------------------------------------------------------
temp<-readxl::read_excel("C:\\Users\\leona\\Dropbox\\Faculdade\\6° Semestre\\Séries Temporais I\\Dados\\oleodiesel.xlsx",sheet = "OLEODIESEL")
