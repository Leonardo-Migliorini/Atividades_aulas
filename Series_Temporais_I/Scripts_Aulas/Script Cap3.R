...
# suppressMessages(library(tsdl)) não tem para essa versão do R
...
# suppressMessages(library(FitAR)) não tem para essav versão do R
...
#-------------------------------------------------------------------------------
covidsm<-readxl::read_excel(
  "C:/Users/leona/Dropbox/Faculdade/6° Semestre/Séries Temporais I/Dados/Covid_SM(2).xlsx",col_types = c("date", "numeric")
)
covidsm<-readxl::read_excel(
  "C:/Users/leona/Dropbox/Faculdade/6° Semestre/Séries Temporais I/Dados/Covid_SM.xlsx",col_types = c("date", "numeric")
)
